...
craftingTable.addShapeless("monster_mash4", blaze_rod, [<item:minecraft:string>, <item:minecraft:gunpowder>, <item:minecraft:rotten_flesh>, <item:minecraft:bone>, <item:minecraft:ender_pearl>, <item:minecraft:spider_eye>]);
